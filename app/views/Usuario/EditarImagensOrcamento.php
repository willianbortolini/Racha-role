...
<div class="row mt-2 mb-2">
    ...
    <div class="col-auto">
        <a href="<?php echo URL_BASE . "User/editarOrcamento/" . $usuarios_id ?>" class="btn btn-primary">Voltar</a>
    </div>
    <div class="col-auto">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('salvaImagem').onclick = function () {
            ...
            const postData = {
                ...
                usuarios_id: '<?php echo $usuarios_id ?>'
                // Outros valores que você deseja enviar como parâmetros POST
            };
            // Envia os dados para o servidor
            fetch('<?php echo URL_BASE . 'User/salvaOrcamento' ?>', {
                method: 'POST',
                headers: {
