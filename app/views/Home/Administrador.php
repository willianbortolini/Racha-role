            ...
            <?php foreach ($orcamentos as $item) {
                if ($item->statusPedido_id == 1) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo (isset($item->total_valor_pedido_item)) ? moedaBr($item->total_valor_pedido_item) : ""; ?>
                        </td>
                        <td>
    ...
    <table id="tabelaPedidos" class="display nowrap" style="width:100%">
        <thead>
            <tr>
                ...
                <th data-sortable="true">Cliente</th>
                <th data-sortable="true">Descrição</th>
                <th data-sortable="true">Data orçamento</th>
                <th data-sortable="true">Data pedido</th>
            ...
            <?php foreach ($pedidos as $item) {
                if ($item->statusPedido_id > 1) { ?>
                    <tr>
                        ...
                        <td>
                            <?php echo databr($item->data_pedido); ?>
                        </td>
                        <td>
