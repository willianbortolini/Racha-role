...
<p>A sua privacidade é importante para nós. É política do w9b2 respeitar a sua privacidade em relação a qualquer
    informação sua que possamos coletar no site w9b2, e outros sites que possuímos e
    operamos.</p>
...
<h2>Política de Cookies w9b2</h2>
...
<ul>
    <li> Cookies relacionados à conta<br><br> Se você criar uma conta conosco, usaremos cookies para o gerenciamento do
...
<p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o w9b2 oferece no site e com caráter
...
<ul>
    ...
    <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou casas de apostas, jogos de sorte e
        azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do w9b2, de seus fornecedores ou
...
<p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa
    ...
    site.</p>
<p>Esta política é efetiva a partir de <strong>Mar</strong>/<strong>2022</strong>.</p>