<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1 class="mt-1">Listagem de Status pedidos</h1>
            <a href="<?php echo URL_BASE . "StatusPedido/create" ?>" class="btn btn-primary mb-3">Adicionar Status
                pedido</a>
            <hr>
            ...
            <table id="tabela" class="table table-bordered">
                ...
                <tbody>
                    <?php foreach ($statusPedido as $item) { ?>
                        <tr>
                            <td>
                                <?php echo $item->statusPedido_id; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="<?php echo URL_BASE . "StatusPedido/edit/" . $item->statusPedido_id ?>"
                                    class="btn btn-primary btn-sm">Editar</a>

                                <button onclick="deletarItem(<?php echo $item->statusPedido_id; ?>)" type="button"
